...
%             else
            ...
            nom = ( abssqr(aGradZ{1})+ abssqr(aGradZ{2})+ abssqr(aGradZ{3})+epsR+abssqr(toRegularize));
            myReg = sum(sign(aGradLap{1}+aGradLap{2}+aGradLap{3}).*(aGradLap{1}+aGradLap{2}+aGradLap{3})./nom);
            
    
            
           
            myRegGrad = (-2)./nom./(BetaVals(1)).^2+ (-2)./nom./(BetaVals(2)).^2+ (-2)./nom./(BetaVals(3)).^2+1./(circshift(nom{1},[-1 0 0]))./(BetaVals(1)).^2 ...
                +1./(circshift(nom,[1 0 0]))./(BetaVals(1)).^2+1./(circshift(nom,[0 -1  0]))./(BetaVals(2)).^2+1./(circshift(nom,[0 1 0]))./(BetaVals(2)).^2+.1/circshift(nom,[0 0 -1])./(BetaVals(3)).^2 ...
                +1./(circshift(nom,[0 0 1]))./(BetaVals(3)).^2 ...
                -sign(circshift(aGradLap{1},[1 0 0])+circshift(aGradLap{2},[1 0 0])+circshift(aGradLap{3},[1 0  0])).*(circshift(aGradLap{1},[1 0 0])+circshift(aGradLap{2},[1 0 0])+circshift(aGradLap{3},[1 0  0]))./(circshift(nom,[1 0  0])).^2 ....
                +sign(circshift(aGradLap{1},[-1 0 0])+circshift(aGradLap{2},[-1 0 0])+circshift(aGradLap{3},[-1 0 0])).*(circshift(aGradLap{1},[-1 0 0])+circshift(aGradLap{2},[-1 0 0])+circshift(aGradLap{3},[-1 0 0]))./(circshift(nom,[-1 0 0])).^2 ...
                -sign(circshift(aGradLap{1},[0 1 0])+circshift(aGradLap{2},[0 1 0])+circshift(aGradLap{3},[0 1 0])).*(circshift(aGradLap{1},[0 1  0])+circshift(aGradLap{2},[0 1  0])+circshift(aGradLap{3},[0  1  0]))./(circshift(nom,[0 1  0])).^2 ....
                +sign(circshift(aGradLap{1},[0 -1 0])+circshift(aGradLap{2},[0 -1 0])+circshift(aGradLap{3},[0 -1 0])).*(circshift(aGradLap{1},[0 -1 0])+circshift(aGradLap{2},[0 -1 0])+circshift(aGradLap{3},[0 -1 0]))./(circshift(nom,[0 -1 0])).^2 ...
                -sign(circshift(aGradLap{1},[0 0 1])+circshift(aGradLap{2},[0 0 1])+circshift(aGradLap{3},[0 0 1])).*(circshift(aGradLap{1},[0 0 1])+circshift(aGradLap{2},[0 0 1])+circshift(aGradLap{3},[0 0 1]))./(circshift(nom,[0 0 1])).^2 ....
                +sign(circshift(aGradLap{1},[0 0 -1])+circshift(aGradLap{2},[0 0 -1])+circshift(aGradLap{3},[0 0 -1])).*(circshift(aGradLap{1},[0 0 -1])+circshift(aGradLap{2},[0 0 -1])+circshift(aGradLap{3},[0  0 -1]))./(circshift(nom,[0 0 -1])).^2 ...
                +sign(circshift(aGradLap{1},[0 0 0])+circshift(aGradLap{2},[0 0 0])+circshift(aGradLap{3},[0 0 0])).*(circshift(aGradLap{1},[0 0 0])+circshift(aGradLap{2},[0 0 0])+circshift(aGradLap{3},[0  0 0]))./(circshift(nom,[0 0 0])).^2;
