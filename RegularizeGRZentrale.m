% [myReg,myRegGrad]=RegularizeGRZentrale(toRegularize,BetaVals,epsR,doConvolve) computes Good's roughness regularisation:
% penalty= ||Grad(f) / (|f|+epsR)||_2^2 (central difference)
