...
if ndims(toRegularize) == 2 || (size(toRegularize,3) == 1)  % Two-D case
    ...
    myProjHessianSqr= H11.*H11 + H22.*H22 + 2*H12.*H12;  % Calculate the sum of the squares of the invidual 2nd derivates
    ...
    myProjHessianSqr= H11 .*H11 + H22.*H22 + H33.*H33 + 2*(H12.*H12+ H13.*H13+ H23.*H23);  % Calculate the sum of the squares of the invidual 2nd derivates
