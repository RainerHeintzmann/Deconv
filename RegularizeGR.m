...
function [myReg,myRegGrad]=RegularizeGR(toRegularize,BetaVals,epsR)
        ...
        if (ndims(toRegularize) == 2) || (size(toRegularize,3) == 1)
            if (ndims(toRegularize) == 2)
                ...
                myRegGrad = ((1/(2*BetaVals(1)*BetaVals(1)))*(2*toRegularize-circshift(toRegularize,[-2 0]) - circshift(toRegularize,[2 0])) + ...
                    (1/(2*BetaVals(2)*BetaVals(2)))*(2*toRegularize-circshift(toRegularize,[0 -2]) - circshift(toRegularize,[0 2])))*sign(toRegularize)  ./ (epsR+abs(toRegularize)) - ...
                    ((aGrad{1}).^2+(aGrad{2}).^2)./((epsR+abs(toRegularize)).^2);
                ...
                myRegGrad = ((1/(2*BetaVals(1)*BetaVals(1)))*(2*toRegularize-circshift(toRegularize,[-2 0 0]) - circshift(toRegularize,[2 0 0])) + ...
                    (1/(2*BetaVals(2)*BetaVals(2)))*(2*toRegularize-circshift(toRegularize,[0 -2 0]) - circshift(toRegularize,[0 2 0])))*sign(toRegularize)  ./ (epsR+abs(toRegularize)) - ...
                    ((aGrad{1}).^2+(aGrad{2}).^2)./((epsR+abs(toRegularize)).^2);
            end
        ...
        elseif ndims(toRegularize) == 3
            ...
            myRegGrad = ((1/(2*BetaVals(1)*BetaVals(1)))*(2*toRegularize-circshift(toRegularize,[-2 0 0])-circshift(toRegularize,[2 0 0])) + ...
                        ...
                        (1/(2*BetaVals(3)*BetaVals(3)))*(2*toRegularize-circshift(toRegularize,[0 0 -2])-circshift(toRegularize,[0 0 2])))*sign(toRegularize) ./ (epsR+abs(toRegularize)) - ...
                        ((aGrad{1}).^2+(aGrad{2}).^2+(aGrad{3}).^2)./((epsR+abs(toRegularize)).^2);
        else % 1-D
            ...
            myRegGrad = ((1/(2*BetaVals(1)*BetaVals(1)))*(2*toRegularize-circshift(toRegularize,-2) - circshift(toRegularize,2)))*sign(toRegularize)  ./ (epsR+abs(toRegularize)) - ...
                        ((aGrad{1}).^2)./((epsR+abs(toRegularize)).^2);
        end 
