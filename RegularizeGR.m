...
function [myReg,myRegGrad]=RegularizeGR(toRegularize,BetaVals,epsR,doConvolve)
        ...
        if (ndims(toRegularize) == 2) || (size(toRegularize,3) == 1)
            if (ndims(toRegularize) == 2)
                ...
                myRegGrad = ((1/(2*BetaVals(1)*BetaVals(1)))*(2*toRegularize-circshift(toRegularize,[-2 0]) - circshift(toRegularize,[2 0])) + ...
                    (1/(2*BetaVals(2)*BetaVals(2)))*(2*toRegularize-circshift(toRegularize,[0 -2]) - circshift(toRegularize,[0 2]))) ./ (epsR+abs(toRegularizeC)) - ...
                    sign(toRegularizeC)*((aGrad{1}).^2+(aGrad{2}).^2)./((epsR+abs(toRegularizeC)).^2);
                ...
                myRegGrad = ((1/(2*BetaVals(1)*BetaVals(1)))*(2*toRegularize-circshift(toRegularize,[-2 0 0]) - circshift(toRegularize,[2 0 0])) + ...
                    (1/(2*BetaVals(2)*BetaVals(2)))*(2*toRegularize-circshift(toRegularize,[0 -2 0]) - circshift(toRegularize,[0 2 0])))  ./ (epsR+abs(toRegularizeC)) - ...
                    sign(toRegularizeC)*((aGrad{1}).^2+(aGrad{2}).^2)./((epsR+abs(toRegularizeC)).^2);
            end
        ...
        elseif ndims(toRegularize) == 3
            ...
            myRegGrad = ((1/(2*BetaVals(1)*BetaVals(1)))*(2*toRegularize-circshift(toRegularize,[-2 0 0])-circshift(toRegularize,[2 0 0])) + ...
                        ...
                        (1/(2*BetaVals(3)*BetaVals(3)))*(2*toRegularize-circshift(toRegularize,[0 0 -2])-circshift(toRegularize,[0 0 2]))) ./ (epsR+abs(toRegularizeC)) - ...
                        sign(toRegularize)*((aGrad{1}).^2+(aGrad{2}).^2+(aGrad{3}).^2)./((epsR+abs(toRegularizeC)).^2);
        else % 1-D
            ...
            myRegGrad = ((1/(2*BetaVals(1)*BetaVals(1)))*(2*toRegularize-circshift(toRegularize,-2) - circshift(toRegularize,2)))  ./ (epsR+abs(toRegularizeC)) - ...
                        sign(toRegularize)*((aGrad{1}).^2)./((epsR+abs(toRegularizeC)).^2);
        end 
